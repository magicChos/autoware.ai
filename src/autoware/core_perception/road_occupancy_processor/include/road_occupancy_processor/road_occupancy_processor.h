...

{
    ...
    struct PointXYZIRT {
        ...
        size_t radial_div;     //index of the radial divsion to which this point belongs to（该点所属的径向分割的索引）
        size_t concentric_div; //index of the concentric division to which this points belongs to(同心分割索引)
