                                                  ...
                                                  float min_x, float min_y, float min_z)
{
    ...
    if (new_max_x > max_x_ || new_max_y > max_y_ || new_max_z > max_z_ || new_min_x < min_x_ || new_min_y < min_y_ || new_min_z < min_z_)
    {
        ...
        if (max_b_x > max_b_x_ || max_b_y > max_b_y_ || max_b_z > max_b_z_ || min_b_x < min_b_x_ || min_b_y < min_b_y_ || min_b_z < min_b_z_)
        {
