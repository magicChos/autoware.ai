 ...
 * @brief 
 * 
 * @param[in] in_cloud_ptr  输入点云
 * @param[out] out_cloud_ptr   输出车道线点云
 * @param in_left_lane_threshold 
 * @param in_right_lane_threshold 
 */
...
/**
 * @brief 将距离大于阈值的点保存到out_cloud_ptr
 * 
 * @param[in] in_cloud_ptr 
 * @param[out] out_cloud_ptr 
 * @param[in] in_distance 
 */
